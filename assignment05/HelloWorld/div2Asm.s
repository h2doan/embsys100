...
*******************************************************************************/   
    ...
    EXTERN myCstrDiv    // myCstrDiv defined outside this file.
...
Description     : Calls C code to print a string; 
                  computes the quotient of its input argument, the dividend,
                  by the divisor of 2. 
C Prototype     : int div2Asm(val)
                : Where val is the value, the dividend, to be divided by 2.
...
div2Asm
    ...
    MOV R1, R0          // R1 = R0
    ASR R0, R1, #0x1    // Arithmetic shift right by 1 to do division by 2.
